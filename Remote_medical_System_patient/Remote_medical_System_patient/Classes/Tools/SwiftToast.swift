...
class ToastView: NSObject {
    ...
    func showLoadingView() {
        ...
        container.backgroundColor = UIColor(displayP3Red: 0, green: 0, blue: 0, alpha: 0)  //半透明黑色背景
    ...
    func showToast(text: String, pos: Position) {
        ...
        lableView.font = UIFont.systemFont(ofSize: 18)
        lableView.textColor = UIColor.white
        lableView.text = text
        lableView.textAlignment = .center
        ...
        let bgView = UIView()
        bgView.backgroundColor = UIColor(displayP3Red: 0.144, green: 0.854, blue: 0.815, alpha: 1)
